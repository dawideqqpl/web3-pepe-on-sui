...
public class Player : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.gameObject.CompareTag("Obstacle")) {
            GameManager.Instance.currentLifes -= 1;
            ...
            if(GameManager.Instance.currentLifes == 1)
            {
        ...
        if (other.gameObject.CompareTag("pizza"))
        {
          ...
          GameManager.Instance.bonusScore++;
            ...
            GameManager.Instance.bonusScoreText.text = GameManager.Instance.bonusScore.ToString();
        // Zniszcz obiekt "Pizza"
